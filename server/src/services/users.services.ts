...
import { sendVerifyRegisterEmail } from '~/utils/mailer'
...
class UsersService {
  ...
  async register(payload: RegisterReqBody) {
    ...
    await this.notifyUserRegistered({ name: payload.name, email: payload.email } as User)
  ...
  async login({ user, verify }: { user: User; verify: UserVerifyStatus }) {
  ...
  async notifyUserRegistered(user: Omit<User, 'password'>) {
    const io = getIO()
